...
sql1 = "SELECT ID_Sample,Patient,Code,SYMBOL from 18_05_HIGH_IMPACT_VARIANT ORDER BY ID_Sample"
sql2 = "INSERT INTO 19_05_PATIENTS_PER_GENE(SYMBOL,Case_cnt,Control_cnt) VALUES('{0}','{1}','{2}')"
