...
sql1 = "INSERT INTO 11_03_PATIENT_VARIANT(Chromosome,Chr_Position,ID_Sample,REF,ALT,ZYG,GT_Bases) VALUES('{0}','{1}','{2}','{3}','{4}','{5}','{6}')"

os.chdir("/Users/superintelligent2/CoV-MadrID.icloud/DATA/MERGED/VCF/ALL/CONCAT/")
