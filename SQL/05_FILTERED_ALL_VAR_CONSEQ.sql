...
-- 'TRBV5_5','TRBV6_5','TRBV6_7','TRBV7_6','TRBV7_7','TRBV7_8','TRBV10_1','TRBV30'
DROP TABLE IF EXISTS `cov`.`30_05_TCR_HIGH_IMPACT_COUNT`;
 CREATE TABLE IF NOT EXISTS `cov`.`30_05_TCR_HIGH_IMPACT_COUNT` ( 
